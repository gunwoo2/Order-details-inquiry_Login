		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "고객 로그인",
									"targetURL": "#synceaorderlogin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceaorderlogin-display": {
								"semanticObject": "synceaorderlogin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.orderlogin",
									"url": sap.ui.require.toUrl("sync/ea/orderlogin")
								}
							}
						}
					}
